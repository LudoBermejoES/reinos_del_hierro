...
![Elias Dunford](/assets/aventuras/cabezaferrea/elias-dunford.png)
...
| Inteligencia | 14 | +2 | Base 13 (5 pts) + 1 (Cygnarano) |
| Sabiduría | 12 | +1 | Base 12 (4 pts) |
| Carisma | 14 | +2 | Base 13 (5 pts) + 1 (Cygnarano) |

*Point buy: 2+7+4+5+4+5 = 27 pts*
...
## Rasgos Raciales (Humano Cygnarano)

- **Mejora de Característica:** INT +1, CAR +1
- **Derecho a Portar Armas:** +1 a tiradas de ataque con armas de fuego sencillas y marciales
- **Bien Educado:** Competencia en Conocimiento Arcano y Medicina
- **Revolución Industrial:** +1d4 a pruebas de característica con herramientas de artesano
- **Idiomas:** Cygnarano, Rhúlico
...
- **Competencias de habilidad:** Perspicacia, Investigación
- **Competencias de herramientas:** Kit de forense
