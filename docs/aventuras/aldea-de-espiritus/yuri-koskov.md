---
layout: default
title: Yuri Koskov - Clérigo
---

# Yuri Koskov

**Clérigo 1** · Humano (Khadorano - Kossite)
...
|----------------|------------|-------------|-------|
| Fuerza | 13 | +1 | Base 13 (5 pts) |
| Destreza | 11 | +0 | Base 11 (3 pts) |
| Constitución | 14 | +2 | Base 13 (5 pts) + 1 (Khadorano) |
| Inteligencia | 10 | +0 | Base 10 (2 pts) |
| Sabiduría | 16 | +3 | Base 13 (5 pts) + 1 (Khadorano) + 2 (Esencia Piadosa) |
| Carisma | 14 | +2 | Base 14 (7 pts) |

*Point buy: 5+3+5+2+5+7 = 27 pts*
...
| Atributo | Valor |
|----------|-------|
| **Clase de Armadura** | 18 (camisa de malla + escudo) |
...
- **Legado del Norte:** Competencia en Supervivencia y Trato con animales
...
- **Canalizador:** Símbolo sagrado de Morrow
...
- **Remendar** — Repara un objeto roto
...
| Objeto | Peso |
|--------|------|
| Camisa de malla | 20 lb. |
| Escudo | 6 lb. |
| Maza | 4 lb. |
| Martillo de guerra | 2 lb. |
| Símbolo sagrado de Morrow | 1 lb. |
...
|------|--------|------|-------------|
| Maza | +3 | 1d6+1 contundente | — |
| Martillo de guerra | +3 | 1d8+1 contundente | Versátil (1d10) |
