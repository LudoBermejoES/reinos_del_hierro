---
layout: default
title: Dmitri Volkov - Paladín del Muro
---

# Dmitri Volkov

**Paladín 1 (Juramento del Muro)** · Humano (Khadorano)
...
|----------------|------------|-------------|-------|
| Fuerza | 15 | +2 | Base 15 (9 pts) |
| Destreza | 11 | +0 | Base 11 (3 pts) |
| Constitución | 14 | +2 | Base 13 (5 pts) + 1 (Khadorano) |
| Inteligencia | 8 | -1 | Base 8 (0 pts) |
| Sabiduría | 12 | +1 | Base 11 (3 pts) + 1 (Khadorano) |
| Carisma | 16 | +3 | Base 14 (7 pts) + 2 (Esencia Piadosa) |

*Point buy: 9+3+5+0+3+7 = 27 pts*
...
## Rasgos de Clase (Paladín 1)

### Imponer las Manos
Reserva de curación de **5 puntos de golpe** (nivel × 5). Como acción adicional, toca a una criatura para restaurar puntos de golpe. Puedes gastar 5 puntos para eliminar el estado envenenado.

### Lanzamiento de Conjuros
- **Espacios de conjuro:** 2 de nivel 1
- **CD de salvación:** 13 (8 + 2 + 3)
- **Modificador de ataque:** +5
- **Conjuros preparados:** 4 (nivel + CAR)

### Maestría con Armas
Puedes usar propiedades de maestría con 2 tipos de armas: **espada larga** y **maza**.
...
### Nivel 1 (2 espacios)
- **Castigo divino** (siempre preparado)
- **Escudo de la fe**
- **Curar heridas**
...
| Maza | 4 lb. |
| Jabalinas (6) | 12 lb. |
| Símbolo sagrado de Menoth | 1 lb. |
...
|------|--------|------|-------------|
| Espada larga | +4 | 1d8+2 cortante | Versátil (1d10) |
| Maza | +4 | 1d6+2 contundente | — |
| Jabalina | +4 | 1d6+2 perforante | Arrojadiza (30/120) |
...
**Esencia:** Piadosa (SAB, CON o CAR +2 → CAR)
