---
layout: default
title: Ivan Starov - Bardo
---

# Ivan Starov

**Bardo 1** · Humano (Khadorano - Khardo)
...
| Destreza | 14 | +2 | Base 14 (7 pts) |
| Constitución | 14 | +2 | Base 13 (5 pts) + 1 (Khadorano) |
| Inteligencia | 11 | +0 | Base 11 (3 pts) |
| Sabiduría | 12 | +1 | Base 11 (3 pts) + 1 (Khadorano) |
| Carisma | 16 | +3 | Base 14 (7 pts) + 2 (Esencia Intelectual) |

*Point buy: 2+7+5+3+3+7 = 27 pts*
...
## Rasgos Raciales (Humano Khadorano)

- **Mejora de Característica:** CON +1, SAB +1
- **Legado del Norte:** Competencia en Atletismo e Intimidación
- **Voluntad de Hierro:** Ventaja en tiradas de salvación contra miedo
- **Resiliencia del Norte:** Bonificador +2 a pruebas y salvaciones de CON
- **Idiomas:** Khadorano, Cygnarano
...
### Inspiración Bárdica
Como **acción adicional**, concede un **d6** a una criatura a 18 m que pueda oírte. Puede usarlo para sumar a una prueba fallida.
**Usos:** 3 (CAR). Recuperas tras descanso largo.
...
- **Canalizador:** Balalaika (instrumento musical)

---

## Trucos

- **Burla cruel** — 1d6 psíquico, desventaja en siguiente ataque
- **Mano de mago** — Mano espectral a 9 m
...
- **Dormir** — 5d8 pg de criaturas dormidas
- **Palabra de curación** — Acción adicional, 1d4+3 pg a 18 m
- **Heroísmo** — Concentración, pg temporales = CAR cada turno
...
|------|--------|------|-------------|
| Espada corta | +4 | 1d6+2 perforante | Ligera, sutil |
| Daga | +4 | 1d4+2 perforante | Ligera, sutil, arrojadiza (20/60) |
| Burla cruel | +5 | 1d6 psíquico | 18 m, salvación SAB |

---

## Trasfondo: Artista

- **Competencias de habilidad:** Interpretación, Persuasión
